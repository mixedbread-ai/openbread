  ...
  it("should move format to description when formats capability is false", () => {
    ...
    const expected = {
      ...
      properties: {
        ...
        email: {
          type: "string",
          description: 'An email field (format: "email")',
        },
      },
    };
      ...
      properties: {
        user: {
          ...
          properties: {
            created_at: {
              type: "string",
              description: 'Creation date (format: "date-time")',
            },
          },
        },
      },
        ...
        dates: {
          ...
          items: {
            ...
            properties: {
              start: {
                type: "string",
                description: 'Start date (format: "date")',
              },
              end: { type: "string", description: 'End date (format: "date")' },
            },
          },
...
describe("applyCompatibilityTransformations", () => {
  ...
  it("should not modify endpoints when all capabilities are enabled", () => {
    ...
    const transformed = applyCompatibilityTransformations(
      endpoints,
      capabilities
    );
